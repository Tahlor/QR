...
#SBATCH --mem 10000
#SBATCH --ntasks 7
#SBATCH --output="default_cconv_alphanumeric.slurm"
...
python -u train.py --config "./configs/auto/___default_cconv_alphanumeric.json" --resume "./saved/default_cconv_alphanumeric/checkpoint-latest.pth" 
