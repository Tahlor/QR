...
#SBATCH --mem 10000
#SBATCH --ntasks 7
#SBATCH --output="resnet__digits_1layer.slurm"
...
python -u train.py --config "./configs/auto/___resnet__digits_1layer.json" --resume "./saved/resnet__digits_1layer/checkpoint-latest.pth" 
