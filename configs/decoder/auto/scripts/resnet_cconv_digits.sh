...
#SBATCH --mem 10000
#SBATCH --ntasks 7
#SBATCH --output="resnet_cconv_digits.slurm"
...
python -u train.py --config "./configs/auto/___resnet_cconv_digits.json" --resume "./saved/resnet_cconv_digits/checkpoint-latest.pth" 
