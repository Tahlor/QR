...
#SBATCH --mem 10000
#SBATCH --ntasks 7
#SBATCH --output="resnet__alphanumeric_LR.slurm"
...
python -u train.py --config "./configs/auto/___resnet__alphanumeric_LR.json" --resume "./saved/resnet__alphanumeric_LR/checkpoint-latest.pth" 
