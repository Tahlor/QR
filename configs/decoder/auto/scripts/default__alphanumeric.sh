...
#SBATCH --mem 10000
#SBATCH --ntasks 7
#SBATCH --output="default__alphanumeric.slurm"
...
python -u train.py --config "./configs/auto/___default__alphanumeric.json" --resume "./saved/default__alphanumeric/checkpoint-latest.pth" 
