...
#SBATCH --mem 10000
#SBATCH --ntasks 7
#SBATCH --output="resnet__alphanumeric.slurm"
...
python -u train.py --config "./configs/auto/___resnet__alphanumeric.json" --resume "./saved/resnet__alphanumeric/checkpoint-latest.pth" 
